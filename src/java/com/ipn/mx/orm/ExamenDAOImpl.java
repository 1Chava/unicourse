...
import com.ipn.mx.model.ExamenKey;
import com.ipn.mx.model.Examen;
...
import com.ipn.mx.dao.ExamenDAO;
...
public class ExamenDAOImpl implements ExamenDAO {
    ...
    public void create(Examen bean, Connection conn) throws SQLException {
        ...
        try {
            ...
            ps.setInt(2, bean.getCalificacion());
            ps.executeUpdate();
        }finally {
            close(ps);
        }
    ...
    public void update(Examen bean, Connection conn) throws SQLException {
        ...
        try {
            ...
            ps.setInt(1, bean.getCalificacion());
    ...
    protected List<Examen> getResults(ResultSet rs) throws SQLException {
        ...
        while (rs.next()) {
            ...
            bean.setCalificacion(rs.getInt("calificacion"));
            results.add(bean);
        }
        return results;
    }
